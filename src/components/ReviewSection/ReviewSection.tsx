...
const REVIEWS = [
  ...
  { id: 4,  image: '/main/review/review_04.jpg', text: '뉴질랜드 어학캠프 보내고 나서 아이가 좀 달라졌어요… 처음엔 영어 때문에 힘들어했는데 점점 적응하더니 자신감이 붙더라고요. 현지 친구들이랑 어울리면서 영어회화도 많이 늘었어요 ㅎㅎ', author: '오*영', tags: ['뉴질랜드 4주', '나홀로'] },
  ...
  { id: 6,  image: '/main/review/review_06.jpg', text: '필리핀 어학캠프는 관리형이라 생활이나 공부 둘 다 잡아줘서 마음이 편했어요… 영어회화 실력도 눈에 띄게 늘었고요. 가성비 생각하면 만족도 높은 영어캠프였던 것 같아요 ㅎㅎ', author: '지*훈', tags: ['필리핀 4주', '나홀로'] },
  { id: 7,  image: '/main/review/review_07.jpg', text: '좀 차분한 분위기라 보내기 괜찮았어요~ 수업이랑 문화체험이 같이 있어서 아이도 지루해하지 않았다고 하네요. 영어에 흥미 붙이기에는 좋은 환경인 것 같아요 ㅎㅎ', author: '신*라', tags: ['영국 4주', '나홀로'] },
  ...
  { id: 9,  image: '/main/review/review_09.jpg', text: '초등학생 영어캠프로 캐나다 선택했는데 잘한 것 같아요~ 자연환경도 좋고 아이가 편안하게 지냈다고 하더라고요. 홈스테이 가족도 잘 챙겨주셔서 영어에 대한 거부감이 많이 줄었어요 ㅎㅎ', author: '이*정', tags: ['캐나다 4주', '나홀로'] },
  { id: 10, image: '/main/review/review_010.jpg', text: '전반적으로 분위기가 안정적이라 마음 놓고 보낼 수 있었어요… 수업이랑 액티비티가 잘 섞여 있어서 영어실력향상에도 도움이 된 것 같고요. 무엇보다 아이가 적극적으로 변한 게 제일 만족스럽네요 ㅎㅎ', author: '최*영', tags: ['캐나다 4주', '나홀로'] },
